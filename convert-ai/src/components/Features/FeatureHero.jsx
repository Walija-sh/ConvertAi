...
className="grid gap-10 max-w-[600px] mx-auto place-content-center relative z-10">
 ...
 <div className="text-black-2 grid gap-4 text-balance">
          <motion.h1 variants={fadeUp} className="text-[32px] md:text-[40px] lg:text-[48px]">Powerful features inside one simple CMR software</motion.h1>
          <motion.p variants={fadeUp}  className='text-[18px] md:text-[19px] lg:text-[20px]'>Streamline your sales process with AI-powered insights and close 50% more deals at faster speed.</motion.p>
        </div>
  </div>
  <motion.div variants={fadeUp} className='mx-auto' >
